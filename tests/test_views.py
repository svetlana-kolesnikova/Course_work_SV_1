...
@patch("src.views.input", side_effect=["2025-06-25 13:00:00"])
@patch("src.views.print")
@patch("src.views.greeting", return_value="Добрый день")
@patch("src.views.is_valid_date", return_value=True)
...
def test_main_page(mock_save, mock_stock, mock_currency, mock_top, mock_cards,
    mock_ops, mock_valid, mock_greeting, mock_print, mock_input) -> Any:
    """
